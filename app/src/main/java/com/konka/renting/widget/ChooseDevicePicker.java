...
public class ChooseDevicePicker<T> extends WheelPicker {
    ...
    private ToGetItemStringCall mGetItemStringCall;

    public ChooseDevicePicker(Activity activity, T[] items) {
    ...
    public ChooseDevicePicker(Activity activity, List<T> items) {
        super(activity);
        setItems(items);
    }

    public void setmGetItemStringCall(ToGetItemStringCall mGetItemStringCall) {
        this.mGetItemStringCall = mGetItemStringCall;
    }
    ...
    public void addItem(T item) {
        items.add(item);
        itemStrings.add(getItemString(item));
    }
    ...
    public void removeItem(T item) {
        items.remove(item);
        itemStrings.remove(getItemString(item));
    }
    ...
    protected View makeCenterView() {
        ...
        if (wheelModeEnable) {
            ...
            wheelListView = new ChooseDeviceListView(activity);
            ...
            wheelListView.setItems(itemStrings, selectedItemIndex);
            wheelListView.setOnWheelChangeListener(new ChooseDeviceListView.OnWheelChangeListener() {
                @Override
...
//    }
    public interface ToGetItemStringCall<T> {
