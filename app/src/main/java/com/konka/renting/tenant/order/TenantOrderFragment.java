...
import com.konka.renting.landlord.order.DoneLFragment;
import com.konka.renting.landlord.order.UnderwayLFragment;
...
public class TenantOrderFragment extends BaseFragment {
    ...
    public static TenantOrderFragment newInstance() {
        ...
        TenantOrderFragment fragment = new TenantOrderFragment();
    ...
    private void initTab() {
        ...
        fragmentList.add(UnderwayTFragment.newInstance());  // 申请中
        fragmentList.add(DoneTFragment.newInstance());   // 入住中
