...
public class OpeningSuccessPopupwindow extends PopupWindow {
    private View mView;
    public OpeningSuccessPopupwindow(Context context) {
        super(context);
        init(context);   //布局
        setPopupWindow();   //布局属性
    }
    ...
    private void init(Context context) {
        ...
        mView=infalter.inflate(R.layout.layout_popup_open_success,null);    //绑定布局
