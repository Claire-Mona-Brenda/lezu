...
public class AgentChooseAdapter  extends BaseAdapter {
    Context context;
    List<AgentBean> list;
    LayoutInflater layoutInflater;
    int curPosition=-1;

    public AgentChooseAdapter(Context context, List<AgentBean> list) {
        this.list = list;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        name.setText(list.get(position).getAgent_name());
        return convertView;
    }
