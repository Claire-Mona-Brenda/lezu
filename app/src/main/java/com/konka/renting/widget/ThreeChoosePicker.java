...
public class ThreeChoosePicker extends WheelPicker {
    ...
    public ThreeChoosePicker(Activity activity) {
        super(activity);
    }

    public ThreeChoosePicker(Activity activity, DataProvider provider) {
        super(activity);
    ...
    public void setSelectedItem(String firstText, String secondText, String thirdText) {
        ...
        List<String> secondData = provider.provideSecondData();
        ...
        List<String> thirdData = provider.provideThirdData();
    ...
    public String getSelectedSecondItem() {
        selectedSecondItem = provider.provideSecondData().get(selectedSecondIndex);
        return selectedSecondItem;
    }

    public String getSelectedThirdItem() {
        selectedThirdItem = provider .provideThirdData().get(selectedThirdIndex);
...
//        wheelParams2.weight = 1;
        ...
        if(wheelModeEnable){
            ...
            secondView.setAdapter(new ArrayWheelAdapter<>(provider.provideSecondData()));
            ...
            if (!provider.isOnlyTwo()) {
                ...
                thirdView.setAdapter(new ArrayWheelAdapter<>(provider.provideThirdData()));
...
//                    thirdView.setItems(thirdData, selectedThirdIndex);
            ...
            secondView.setItems(provider.provideSecondData(), selectedSecondIndex);
...
//                    thirdView.setItems(thirdData, selectedThirdIndex);
            ...
            thirdView.setItems(provider.provideThirdData(), selectedThirdIndex);
    ...
    public interface DataProvider {
         ...
         * 提供第二级数据
         */
        List<String> provideSecondData();

        /**
         * 提供第三级数据
         */
        List<String> provideThirdData();
    ...
    public static class DefaultDataProvider implements DataProvider {
        ...
        public DefaultDataProvider(List<String> firstList, List<String> secondList,
